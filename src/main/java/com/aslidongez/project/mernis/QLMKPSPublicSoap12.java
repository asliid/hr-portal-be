...
public class QLMKPSPublicSoap12
{
    ...
    public QLMKPSPublicSoap12()
    {
    }

    public QLMKPSPublicSoap12(String url)
    {
        this.url=url;
    }

    public QLMKPSPublicSoap12 (String url,QLMConnectionProvider connectionProvider) {
        this.url=url;
    ...
    {
        QLMRequestResultHandler handler = new QLMRequestResultHandler(QLMSoapVersion.v1_2);
        return handler;
    }
